...
This work was largely inspired by the B-spline basis function used in [PoissonRecon](https://github.com/mkazhdan/PoissonRecon), the neural point representation of [PIN-SLAM](https://github.com/PRBonn/PIN_SLAM) and the splatting algrithm of [3DGS](https://github.com/graphdeco-inria/gaussian-splatting).
